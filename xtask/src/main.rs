...
const PACKAGE_NAME: &str = "rust-template-generated-bin";
const EXECUTABLE_NAMES: &[&str] = &["rust-template-generated-bin"];

#[derive(Debug, Parser)]
#[clap(author, version, about)]
enum Cmd {
    /// Package the  and produce a set of distributable artifacts
    Dist(DistArgs),
}
